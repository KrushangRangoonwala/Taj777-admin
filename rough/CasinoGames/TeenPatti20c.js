...
const TeenPatti20c = ({ onBetSelection, lastBetTime, exposureTrigger }) => {
  ...
  useEffect(() => {
    ...
    const joinRoom = () => {
      console.log("📤 Emitting Room: teen20c");
      socket.emit("Room", "teen20c");
    };

    socket.on("connect", () => {
      console.log("✅ Connected to game socket (teen20c):", socket.id);
      joinRoom();
    });

    socket.on("reconnect", (attempt) => {
      console.log(
        `🔄 Reconnected to game socket (teen20c) after ${attempt} attempts`
      );
      joinRoom();
    });
    ...
    <>
      <div className="casino-table teenpatti20b kk">
        ...
        <CasinoVideo
          ...
          videoSrc="/mediaplayer/teen20c/95bba40e-0623-4fe3-a007-0b71f467e211"
