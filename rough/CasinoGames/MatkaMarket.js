...
const MatkaMarket = ({ onBetSelection, lastBetTime, exposureTrigger }) => {
    ...
    const fetchExposure = async () => {
      ...
      try {
        const response = await fetchCasinoExposureApi({
          ...
          curPageName: "live_matka_market.php",
        });
  ...
  /* ================= BET CLICK ================= */
  const handleOddsClick = (teamName, odds, marketId) => {
      ...
      <div className="d-none-desktop card-clear-box">
        ...
        <div>
          ...
          <button
            ...
            onClick={() => {
              const oddsToPlace = calculateOdds(tab, selectedBets);
              onBetSelection?.({
                teamName: sortedBets.map((b) => b.teamName).join(", "),
                odds: oddsToPlace,
...
console.log("Total Pana:", totalPanas.map((p) => p.number));
  ...
  return (
    <>
      ...
      `}</style>
      <div className="casino-table worli matka kk">
        <CasinoVideo
        ...
        <div className="casino-detail">
            <div className="matka-coins">
                ...
                <span className="d-none d-md-flex">
                    SET YOUR COIN AMOUNT
                    <br />
                    AND START 1-CLICK BET!
                </span>
                ...
                <div className="casino-coin">
                    ...
                    style={{ "--g-chip-inner-color": "#502b63" }}
                    >
                ...
                {[25, 50, 100, 200, 500, "1K"].map((coin, index) => (
                    <React.Fragment key={index}>
                    <div className="casino-coin">
                        <div
                        className="bet-chip-holder"
                        style={{ "--g-chip-inner-color": "#1f6179" }}
                        >
                        <div className="bet-chip">
                            <div className="bet-chip-front"></div>
                            <div className="bet-chip-top"></div>
            ...
            <div className="casino-box tab-content">
                <div id="jodi" className="tab-pane jodi active">
                <div className="worlibox">
                    ...
                    <div className="worli-box-row">
                        ...
                        const col = i % 10;
                        return (
                            <div className="worli-odd-box back" key={i}>
                ...
                {/* You can paste remaining tab content exactly same way */}
            </div>

            {/* Results */}
            <div className="casino-video-last-results matka-result">
                {[
                "Diamond",
                "World",
                "Taj",
                ...
                <span key={i} className="resultb">
                    {item}
                </span>
                ))}
                <a
                href="/report/casinoresult/worli3"
      ...
      <style>
        {`
          @media only screen and (min-width: 320px) and (max-width: 767px) {
            ...
            .sp .worli-right .worli-odd-box, .dp .worli-right .worli-odd-box, .card56 .56-charts .worli-right .worli-odd-box, .card64 .worli-right .worli-odd-box, .colordp .worli-right .worli-odd-box {
                height: 142px;
                width: 100%;
            }
            ...
            .56-charts .worli-right .worli-odd-box,
            .64-charts .worli-right .worli-odd-box,
            ...
            .matka .matka-coins .matka-total-coin .casino-coin, .matka .matka-coins .matka-other-coins .casino-coin {
                display: flex;
                justify-content: center;
                align-items: center;
            }
            ...
            .matka.worli .casino-tabs .nav-tabs {
                flex-direction: column;
            }
            ...
            .matka.worli .casino-box {
                flex: 1;
                margin-left: 4px;
            }

            .matka .bet-chip-amount text {
                font-size: 28px;
            }
