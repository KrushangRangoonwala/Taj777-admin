...
import { getExposureClass, getImage } from "../../utilies/helpers";
import CasinoVideo from "./components/CasinoVideo";

const InstantTeenPatti = ({ onBetSelection, lastBetTime, exposureTrigger }) => {
  ...
  const handleResultClick = async (clickedIndex) => {
    ...
    try {
      ...
      const response = await fetchTeenpattiResults(mid, "teen3");
  ...
  useEffect(() => {
    ...
    const joinRoom = () => {
      console.log("📤 Emitting Room: teen3");
          ...
          .mobile-section {
            ...
            border-radius: 4px;
                   ...
                   .casino-video-right-icons i {
                       // font-size: 12px !important; /* Reduced icon size */
                   }
            ...
            <div style={{ padding: "15px", backgroundColor: "#333b41" }}>
                  ...
                  <div style={{ textAlign: "center" }}>
                    ...
                    >
                      {modalContent.playerA.cards.map((c, i) => (
                        ...
                        >
                          <img
                            src={`https://wver.sprintstaticdata.com/v190/static/front/img/cards/\${c}.png`}
                            width="100%"
                            alt={c}
                          />
                        </div>
              ...
              >
                ...
                <div style={{ display: "flex", marginBottom: "5px" }}>
                  ...
                  <span style={{ color: "#ccc" }}>{modalContent.oddEven}</span>
                </div>
                <div style={{ display: "flex" }}>
                  ...
                  <span style={{ color: "#ccc" }}>
                    <span
                      style={{
                        color: modalContent.playerA.consecutive
                          ? "#ccc"
                          : "#ccc",
                      }}
                    >
                    ...
                    <span
                      style={{
                        color: modalContent.playerB.consecutive
                          ? "#ccc"
                          : "#ccc",
                      }}
                    >
