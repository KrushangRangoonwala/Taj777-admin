...
const Result_OneCardOneDay = ({ modalContent }) => {
    ...
    // Assuming rdesc format: "Dealer#P : Down | D : Down" or similar
    // Based on provided HTML, the labels are "Winner" and "7 Up - 7 Down"
...
export default Result_OneCardOneDay;
