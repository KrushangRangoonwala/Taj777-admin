...
const Result_TeenPatti41 = ({ modalContent: response }) => {
    ...
    const resultData = [
        ...
        { label: "Consecutive", value: modalContent?.consecutive || "" },
        { label: "Under/Over", value: modalContent?.oddEven || "" },
    ]
...
export default Result_TeenPatti41;
