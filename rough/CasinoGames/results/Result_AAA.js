...
const Result_AAA = ({ modalContent: response }) => {
...
const parseDescription = (desc) => {
    ...
    if (separator === "|") {
        // Pipe format (AAA): "Akbar | Black | Even | Over 7 | Card 8"
    ...
    // Hash format (AAA2): "Akbar#Even#Black#Over 7#8"
    return {
        winner: parts[0] || "",
        oddEven: parts[1] || "",
        color: parts[2] || "",
