...
const Result_InstantTeenPatti = ({ modalContent: response }) => {
    ...
    const resultData = [{ label: "Winner", value: modalContent?.winner || "" }];

    return (
        <div
            style={{
                // background: "#2e3439",
                padding: isMobile ? "0px" : "0px 12px 0px",
                overflowX: "auto",
            }}
        >
            <div
...
export default Result_InstantTeenPatti;
