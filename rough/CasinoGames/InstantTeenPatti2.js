...
const InstantTeenPatti2 = ({
  ...
  const renderExposure = (marketId) => {
    ...
    return (
      <span
        style={{ marginLeft: "50px", color: exposure >= 0 ? "#39FF39" : "#F7505E" }}
      >
        {exposure}
      </span>
    );
  ...
  useEffect(() => {
    ...
    const joinRoom = () => {
      console.log("📤 Emitting Room: teen32");
...
CasinoVideo                   .casino-video-title .casino-video-rid {
      ...
      <div className="casino-table teenpatti-new">
        {/* VIDEO SECTION */}
        <CasinoVideo
          gameName="Instant Teenpatti 2.0"
