...
const PlacebetBaccarat2 = ({
    ...
    socket.on("gameResult", (data) => {
      ...
      if (results.length > 0) {
        ...
        socketRef.current.eventData = {
          ...
          gtype: latestResult.gtype || "baccarat2",
        };
  ...
  const handleSubmit = async () => {
    ...
    params.append("eventType", "BACCARAT2");
    ...
    params.append("bet_market_type", "BACCARAT2");
    params.append("oddsmarketId", marketId);
    params.append("eventManualType", "Auto");
    params.append("market_runner_name", teamName);
    params.append("market_odd_name", "BACCARAT2");
    params.append("bet_event_name", "BACCARAT2");
    ...
    try {
      setIsLoading(true);
      const response = await placeBetBaccarat2Api(params);
      if (isApiSuccess(response)) {
        toast.success(response?.message || "Bet placed successfully!");
        refreshBalanceApi(dispatch, { curPageName: "live_baccarat2.php" });
      ...
      {!hideResults && (
        <div className="casino-place-bet">
          ...
          <div className="casino-video-last-results">
            ...
            <a href="/report/casinoresult/baccarat2" className="result-more">
              ...
            </a>
          </div>
        </div>
...
export default PlacebetBaccarat2;
