...
const Lucky7eu2 = ({ onBetSelection, lastBetTime, exposureTrigger }) => {
    ...
    const BettingBox = ({ sid, teamName, boxType = "back", customOdds, label, children, containerClass = "lucky7-extra-bets-item" }) => {
        ...
        return (
            <div
                className={`${containerClass} ${suspended ? "suspended" : ""}`}
    ...
    return (
        <div className="casino-table lucky7 lucky7eu lucky7eu2">
            <CasinoVideo
                gameName={game_name}
                    ...
                    <div className="w-100">
                        <div className="casino-odds">
                            {(() => {
                                ...
                                const market = getOddsBySid(11);
                                const suspended = market ? isSuspended(market.gstatus) : true;
                                return suspended ? "0" : formatOdds(market?.b1 ?? market?.rate ?? market?.odds ?? "12");
                            })()}
                        </div>
                        <div className="casino-cards text-center mt-1">
