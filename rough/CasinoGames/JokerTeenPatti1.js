...
const JokerTeenPatti1 = ({
    ...
    useEffect(() => {
        ...
        const joinRoom = () => {
            console.log("📤 Emitting Room: joker1");
    ...
    const gameTitle = "Unlimited Joker Oneday";
    const videoUrl = "https://shivetv.pw/live/joker1.m3u8";
    ...
    text-shadow: 0 0 1px var(--text-yellow);}
        ...
        `}
            ...
            <div className="casino-table teenpatti-joker1 kk" style={{ marginTop: 0 }}>
                <CasinoVideo
                    gameName={gameTitle}
...
export default JokerTeenPatti1;
