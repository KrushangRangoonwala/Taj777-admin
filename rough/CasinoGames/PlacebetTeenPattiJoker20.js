...
const TeenPattiJoker20ResultModalContent = ({ modalContent, onClose }) => {
...
const PlacebetTeenPattiJoker20 = ({
  betData,
  onSubmit,
  onClose,
  hideResults,
  ...
  const config = {
    marketType: "joker20",
    curPageName: "live_joker20.php",
    socketRoom: "joker20",
    resultApiType: "joker20",
    placeBetUrl: "bet_place_joker20.php",
    gtype: "joker20",
    placeBetParams: {
      eventType: "joker20",
      marketOddName: "joker20",
      betEventName: "joker20",
      betMarketType: "joker20",
    },
  ...
  return (
    <PlaceBet_KK
      ...
      ResultModal={TeenPattiJoker20ResultModalContent}
...
export default PlacebetTeenPattiJoker20;
