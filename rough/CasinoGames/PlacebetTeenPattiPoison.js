...
const TeenPattiPoisonResultModalContent = ({ modalContent, onClose }) => {
    ...
    return (
        <>
            ...
            >
                ...
                >
                    Teenpatti Poison One Day Result
                </span>
                <span
                    onClick={onClose}
                    style={{
...
const PlacebetTeenPattiPoison = ({
    ...
    const formatResultData = useCallback((result) => {
        ...
        // Poison logic (assuming same as Joker 20-20):
        // allCards[0] is likely the Poison card (C1)
    ...
    const config = {
        marketType: "poison",
        curPageName: "live_poison.php",
        socketRoom: "poison",
        resultApiType: "poison",
        placeBetUrl: "bet_place_poison.php",
        gtype: "poison",
        placeBetParams: {
            eventType: "poison",
            marketOddName: "poison",
            betEventName: "poison",
            betMarketType: "poison",
        },
        modalTitle: "Teenpatti Poison One Day Result",
    ...
    return (
        <PlaceBet_KK
            ...
            // ResultModal={TeenPattiPoisonResultModalContent}
...
export default PlacebetTeenPattiPoison;
