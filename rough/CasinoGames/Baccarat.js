...
const Baccarat = ({ onBetSelection, lastBetTime, exposureTrigger }) => {
    ...
    .baccarat .banker img {
      ...
      <div className="casino-table baccarat">
        ...
        <CasinoVideo
          ...
          videoSrc="https://casino.diamondcricketid.com/swiftdizire/?id=3044"
          ...
          {isMobile ? (
            <>
              <div className="baccarat-bets-odds">
                {/* Top Row: baccarat-odds */}
                <div className="baccarat-odds">
                  {[
                    { sid: 6, name: "Perfect Pair" },
                    { sid: 7, name: "Big" },
                    { sid: 8, name: "Small" },
                    { sid: 9, name: "Either Pair" },
                  ].map((odd) => {
                    ...
                    return (
                      <div
                        ...
                        onClick={() =>
                          !isSuspended &&
                          market?.b1 &&
                          handleOddsClick(odd.name.toUpperCase(), market.b1, odd.sid)
                        }
                      >
                        <div className={`baccarat-odd-name  ${isSuspended ? "suspended" : ""}`} style={{ position: "relative" }}>
                          {odd.name} {formatOdds(market?.b1) ?? '-'}
                        </div>
                ...
                {/* Main Betting Area: baccarat-bets */}
                    ...
                    return (
                      <div
                        ...
                        onClick={() =>
                          !isSuspended &&
                          market?.b1 &&
                          handleOddsClick(bet.name.toUpperCase(), market.b1, bet.sid)
                        }
                      >
                        <div className={`baccarat-bets-name ${isSuspended ? "suspended" : ""}`}>
                          <div>{bet.name}</div>
                          <div className="mb-0">{formatOdds(market?.b1) ?? "-"}</div>
                        </div>
                  ...
                  {(() => {
                    ...
                    return (
                      ...
                      >
                        <div className={`baccarat-bets-name ${isSuspended ? "suspended" : ""}`}>
                          <div>
                            {bet.name} {formatOdds(market?.b1) ?? "-"}
                          </div>
                          <div className="mb-0">
                            {isActive(c3Val) && (
                              <span className="l-rotate" style={{ marginRight: "2px" }}>
                                <img src={getCardImage(c3Val)} alt="C5" />
                              </span>
                            )}
                            <span><img src={getCardImage(c2Val)} alt="C3" /></span>
                    ...
                    return (
                      ...
                      >
                        <div className={`baccarat-bets-name ${isSuspended ? "suspended" : ""}`}>
                          ...
                          <div className="mb-0">
                            <span><img src={getCardImage(c1Val)} alt="C2" /></span>
                            <span><img src={getCardImage(c2Val)} alt="C4" /></span>
                            {isActive(c3Val) && (
                              <span className="r-rotate" style={{ marginLeft: "2px" }}>
                                <img src={getCardImage(c3Val)} alt="C6" />
                              </span>
                            )}
                          </div>
                        </div>
              ...
              <div className="baccarat-mobile-layout" style={{ width: "100%" }}>
                {/* Statistics Header */}
                      ...
                      <div dir="ltr">
                        ...
                        >
                          ...
                          <g>
                            ...
                            ></path>
                            <path
                              d="M52,75.1L52,84.9L78.2,118L78.2,108.2"
                              fill="#06518a"
                            ></path>
                            <path
                          ...
                          <g>
                            <path
                              d="M52,75.1L52,84.9L20.8,54.7L20.8,44.9"
                              fill="#1d7026"
                            ></path>
                            <path
