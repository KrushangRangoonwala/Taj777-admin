...
const TeenPattiTest = ({ onBetSelection, lastBetTime, exposureTrigger }) => {
    ...
    const fetchExposure = async () => {
      ...
      try {
        const response = await fetchCasinoExposureApi({
          ...
          main_event_id: gameData.t1[0].mid == 0 ? 0 : gameData.t1[0].mid.split(".")[1],
          curPageName: "live_teenpatti_test.php",
        });
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("✅ Connected to game socket teen9:", socket.id);
  ...
  const renderMarketBox = (odds, status, marketId, teamName) => {
    const isLocked =
      status === "False" ||
      status === false ||
      !odds ||
    ...
    return (
      ...
      <div
        ...
        onClick={() =>
          !isLocked && handleOddsClick(teamName, odds, marketId, true)
        }
  ...
  const groups = [
    { name: "tiger", cards: communityCards.slice(0, 3) },
    { name: "lion", cards: communityCards.slice(3, 6) },
    { name: "Dragon", cards: communityCards.slice(6, 9) },
  ];
    ...
    return (
      <div>
        {groups.map((group, gIdx) => (
          <div>
            <div key={gIdx} className="dealer-name">{group.name}</div>
            <div>
              {group.cards.map((card, idx) => (
                <span key={`${group.name}-${idx}`}>
                  <img
  ...
  return (
    <>
      ...
      `}</style>
      <div className="casino-table teenpattitest kk">

        <CasinoVideo
          gameName="Teenpatti Test"
          roundId={currentGame?.mid}
          videoSrc="/mediaplayer/test_teenpatti/95bba40e-0623-4fe3-a007-0b71f467e211"
          isCardDrawerOpen={isCardDrawerOpen}
          setIsCardDrawerOpen={setIsCardDrawerOpen}
          autotime={currentGame?.autotime}
          totalTime={currentGame?.ft}cards={communityCards}
        ...
        <div className="casino-detail">
          <div className="teen1daycasino-container d-none-small">
            <div className="teentestother">
              ...
              {/* Header Row */}
              <div className="casino-box-row" style={{ fontSize: "14px" }}>
                <div className="casino-nation-name no-border"></div>

                <div className="casino-bl-box"><div className="casino-bl-box-item"><b>Winner</b></div></div>
                <div className="casino-bl-box"><div className="casino-bl-box-item"><b>Pair</b></div></div>
                <div className="casino-bl-box"><div className="casino-bl-box-item"><b>Flush</b></div></div>
                <div className="casino-bl-box"><div className="casino-bl-box-item"><b>Straight</b></div></div>
                <div className="casino-bl-box"><div className="casino-bl-box-item"><b>Trio</b></div></div>
                <div className="casino-bl-box"><div className="casino-bl-box-item"><b>Straight Flush</b></div></div>
              </div>
              ...
              {[
                ...
                <div className="casino-box-row" key={animal.name}>
                  <div className="casino-nation-name">
                    <b>{animal.name}</b>
                  </div>

                  {gameData?.t2?.map((market, index) => {
                    const rate = market?.[`${animal.key}rate`];
                    const status = market?.[`${animal.key}status`];
                    const section =
                      animal.key === "d"
                        ? market?.dsectionid
                        : market?.[`${animal.key}section`];
                    ...
                    return (
                      <div className="casino-bl-box" key={index}>
                        {renderMarketBox(
                          ...
                          section,
                          `${animal.name} ${
                            ["Winner", "Pair", "Flush", "Straight", "Trio", "Straight Flush"][index]
                          }`
                        )}
                      </div>
                    );
          ...
          <div className="teen1daycasino-container d-none-big">
            <div className="casino-box-row teen1dayodev">
              ...
              <div className="casino-bl-box casino-bl-box-title">
                ...
                <div className="casino-bl-box-item"><b>Tiger</b></div>
                <div className="casino-bl-box-item"><b>Lion</b></div>
                <div className="casino-bl-box-item"><b>Dragon</b></div>
              </div>

              {/* Winner */}
              <div className="casino-bl-box">
                <div className="casino-bl-box-item casino-odds-name"><span>Winner</span></div>
                {renderMarketBox(gameData?.t2?.[0]?.trate, gameData?.t2?.[0]?.tstatus, gameData?.t2?.[0]?.tsection, "Tiger Winner")}
                {renderMarketBox(gameData?.t2?.[0]?.lrate, gameData?.t2?.[0]?.lstatus, gameData?.t2?.[0]?.lsection, "Lion Winner")}
                {renderMarketBox(gameData?.t2?.[0]?.drate, gameData?.t2?.[0]?.dstatus, gameData?.t2?.[0]?.dsectionid, "Dragon Winner")}
              </div>

              {/* Pair */}
              <div className="casino-bl-box">
                <div className="casino-bl-box-item casino-odds-name"><span>Pair</span></div>
                {renderMarketBox(gameData?.t2?.[1]?.trate, gameData?.t2?.[1]?.tstatus, gameData?.t2?.[1]?.tsection, "Tiger Pair")}
                {renderMarketBox(gameData?.t2?.[1]?.lrate, gameData?.t2?.[1]?.lstatus, gameData?.t2?.[1]?.lsection, "Lion Pair")}
                {renderMarketBox(gameData?.t2?.[1]?.drate, gameData?.t2?.[1]?.dstatus, gameData?.t2?.[1]?.dsectionid, "Dragon Pair")}
              </div>

              {/* Flush */}
              <div className="casino-bl-box">
                <div className="casino-bl-box-item casino-odds-name"><span>Flush</span></div>
                {renderMarketBox(gameData?.t2?.[2]?.trate, gameData?.t2?.[2]?.tstatus, gameData?.t2?.[2]?.tsection, "Tiger Flush")}
                {renderMarketBox(gameData?.t2?.[2]?.lrate, gameData?.t2?.[2]?.lstatus, gameData?.t2?.[2]?.lsection, "Lion Flush")}
                {renderMarketBox(gameData?.t2?.[2]?.drate, gameData?.t2?.[2]?.dstatus, gameData?.t2?.[2]?.dsectionid, "Dragon Flush")}
              </div>

              {/* Straight */}
              <div className="casino-bl-box">
                <div className="casino-bl-box-item casino-odds-name"><span>Straight</span></div>
                {renderMarketBox(gameData?.t2?.[3]?.trate, gameData?.t2?.[3]?.tstatus, gameData?.t2?.[3]?.tsection, "Tiger Straight")}
                {renderMarketBox(gameData?.t2?.[3]?.lrate, gameData?.t2?.[3]?.lstatus, gameData?.t2?.[3]?.lsection, "Lion Straight")}
                {renderMarketBox(gameData?.t2?.[3]?.drate, gameData?.t2?.[3]?.dstatus, gameData?.t2?.[3]?.dsectionid, "Dragon Straight")}
              </div>

              {/* Trio */}
              <div className="casino-bl-box">
                <div className="casino-bl-box-item casino-odds-name"><span>Trio</span></div>
                {renderMarketBox(gameData?.t2?.[4]?.trate, gameData?.t2?.[4]?.tstatus, gameData?.t2?.[4]?.tsection, "Tiger Trio")}
                {renderMarketBox(gameData?.t2?.[4]?.lrate, gameData?.t2?.[4]?.lstatus, gameData?.t2?.[4]?.lsection, "Lion Trio")}
                {renderMarketBox(gameData?.t2?.[4]?.drate, gameData?.t2?.[4]?.dstatus, gameData?.t2?.[4]?.dsectionid, "Dragon Trio")}
              </div>

              {/* Straight Flush */}
              <div className="casino-bl-box">
                <div className="casino-bl-box-item casino-odds-name"><span>Straight Flush</span></div>
                {renderMarketBox(gameData?.t2?.[5]?.trate, gameData?.t2?.[5]?.tstatus, gameData?.t2?.[5]?.tsection, "Tiger Straight Flush")}
                {renderMarketBox(gameData?.t2?.[5]?.lrate, gameData?.t2?.[5]?.lstatus, gameData?.t2?.[5]?.lsection, "Lion Straight Flush")}
                {renderMarketBox(gameData?.t2?.[5]?.drate, gameData?.t2?.[5]?.dstatus, gameData?.t2?.[5]?.dsectionid, "Dragon Straight Flush")}
              </div>
