...
const TeenPattiPOISON20ResultModalContent = ({ modalContent, onClose }) => {
...
const PlacebetTeenPattiPOISON20 = ({
    betData,
    onSubmit,
    onClose,
    hideResults,
    ...
    const formatResultData = useCallback((result) => {
        ...
        // 20-20 Teenpatti Poison logic:
        // allCards[0] is likely the Poison (C1)
        // Player A gets C2, C4, C6 -> indices 1, 3, 5
        // Player B gets C3, C5, C7 -> indices 2, 4, 6
        if (allCards.length >= 7) {
            ...
            // Fallback or legacy handling if fewer cards
    ...
    const config = {
        marketType: "POISON20",
        curPageName: "live_POISON20.php",
        socketRoom: "poison20",
        resultApiType: "POISON20",
        placeBetUrl: "bet_place_poison20.php",
        gtype: "POISON20",
        placeBetParams: {
            eventType: "POISON20",
            marketOddName: "POISON20",
            betEventName: "POISON20",
            betMarketType: "POISON20",
        },
        modalTitle: "Teenpatti Poison 20-20 Result",
    ...
    return (
        <PlaceBet_KK
            ...
            // ResultModal={TeenPattiPOISON20ResultModalContent}
...
export default PlacebetTeenPattiPOISON20;
