...
const TeenPattiPoison = ({ onBetSelection, lastBetTime, exposureTrigger }) => {
    ...
    <>
      <style>
        {`
          ...
          .poison-odds-box.has-exposure {
            padding-bottom: 10px !important;
          }
          .poison-odds-box.suspended:before {
            background-position: center center !important;
          }
          .poison-odds-box.suspended.has-exposure:before {
            ...
            <div className="teenpatti-mobile-container">
              ...
              <div className="mobile-section-container">
                ...
                >
                  {/* Even - SID 3 */}
                  <div
                    className={`mobile-odds-box back poison-odds-box ${getExposure(3) !== 0 ? "has-exposure" : ""
                  ...
                  {/* Odd - SID 4 */}
                  <div
                    className={`mobile-odds-box back poison-odds-box ${getExposure(4) !== 0 ? "has-exposure" : ""
                    ...
                    onClick={() =>
                      handleOddsClick("Poison Odd", getOddsBySid(4)?.b1, 4, true)
                    }
                  >
                    Odd
                  ...
                  {/* Red - SID 5 */}
                  <div
                    className={`mobile-odds-box back poison-odds-box ${getExposure(5) !== 0 ? "has-exposure" : ""
                      } ${getSuspendedClass(getOddsBySid(5)?.gstatus)}`}
                    style={{ height: "50px" }}
                    onClick={() =>
                      handleOddsClick("Poison Red", getOddsBySid(5)?.b1, 5, true)
                    }
                  >
                    <div
                      style={{
                  ...
                  {/* Black - SID 6 */}
                  <div
                    className={`mobile-odds-box back poison-odds-box ${getExposure(6) !== 0 ? "has-exposure" : ""
                ...
                >
                  ...
                  <div
                    ...
                    style={{ height: "auto", minHeight: "50px", flexDirection: "column" }}
                    onClick={() =>
                      handleOddsClick(
                        "Poison Spade",
                        getOddsBySid(7)?.b1,
                  ...
                  >
                    {!isSuspended(getOddsBySid(7)?.gstatus) ? (
                      getOddsBySid(7)?.b1
                    ) : (
                      <i
                  ...
                  >
                    {!isSuspended(getOddsBySid(8)?.gstatus) ? (
                      getOddsBySid(8)?.b1
                    ) : (
                      <i
                        className="fas fa-lock"
                  ...
                  >
                    {!isSuspended(getOddsBySid(9)?.gstatus) ? (
                      getOddsBySid(9)?.b1
                    ) : (
                      <i
                        className="fas fa-lock"
                  ...
                  >
                    {!isSuspended(getOddsBySid(10)?.gstatus) ? (
                      getOddsBySid(10)?.b1
                    ) : (
                      <i
                        className="fas fa-lock"
              ...
              <div className="teen1dayright" style={{ width: "49%" }}>
                ...
                <div className="casino-box-row">
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{ flex: 1, flexDirection: "column", height: "auto", minHeight: "45px" }}
                      onClick={() =>
                        handleOddsClick(
                          "Poison Even",
                          getOddsBySid(3)?.b1,
                    ...
                    {/* Red - SID 5 */}
                    <div
                      className={`back casino-bl-box-item poison-odds-box ${getExposure(5) !== 0 ? "has-exposure" : ""
                        } ${getSuspendedClass(getOddsBySid(5)?.gstatus)}`}
                    ...
                    {/* Black - SID 6 */}
                    <div
                      className={`back casino-bl-box-item poison-odds-box ${getExposure(6) !== 0 ? "has-exposure" : ""
                        } ${getSuspendedClass(getOddsBySid(6)?.gstatus)}`}
                      style={{ flex: 1, height: "45px" }}
                      onClick={() =>
                        handleOddsClick(
                ...
                <div className="casino-box-row">
                  ...
                  >
                    {/* Spade - SID 7 */}
                    <div
                      className={`back casino-bl-box-item poison-odds-box ${getExposure(7) !== 0 ? "has-exposure" : ""
                    ...
                    {/* Heart - SID 8 */}
                    <div
                      className={`back casino-bl-box-item poison-odds-box ${getExposure(8) !== 0 ? "has-exposure" : ""
                    ...
                    {/* Diamond - SID 9 */}
                    <div
                      className={`back casino-bl-box-item poison-odds-box ${getExposure(9) !== 0 ? "has-exposure" : ""
                    ...
                    {/* Club - SID 10 */}
                    <div
                      className={`back casino-bl-box-item poison-odds-box ${getExposure(10) !== 0 ? "has-exposure" : ""
...
export default TeenPattiPoison;
