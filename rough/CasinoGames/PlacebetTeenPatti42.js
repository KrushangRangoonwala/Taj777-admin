...
const TeenPatti42ResultModalContent = ({ modalContent, onClose }) => {
  ...
  return (
    <>
      ...
      >
        ...
        >
          Jack Top Open Teenpatti Result
        </span>
        <span
          onClick={onClose}
          style={{
...
const PlacebetTeenPatti42 = ({
  ...
  const config = {
    marketType: "teen42",
    curPageName: "live_teen42.php",
    socketRoom: "teen42",
    resultApiType: "teen42",
    placeBetUrl: "bet_place_teen42.php",
    gtype: "teen42",
    placeBetParams: {
      eventType: "teen42",
      marketOddName: "teen42",
      betEventName: "teen42",
      betMarketType: "teen42",
    },
    modalTitle: "Jack Top Open Teenpatti Result",
  ...
  return (
    <PlaceBet_KK
      ...
      ResultModal={TeenPatti42ResultModalContent}
...
export default PlacebetTeenPatti42;
