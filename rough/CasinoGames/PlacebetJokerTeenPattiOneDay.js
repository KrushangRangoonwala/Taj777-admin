...
const PlacebetTeenPattijoker1 = ({
  ...
  const config = {
    marketType: "joker120", // JOKER120 - Note : In saffron its is "joker120" in lowercase
    curPageName: "live_joker1.php",
    socketRoom: "joker120",
    resultApiType: "joker120", // JOKER120 - Note : In saffron its is "joker120" in lowercase
    placeBetUrl: "bet_place_joker120.php",
    gtype: "joker120", // JOKER120 - Note : In saffron its is "joker120" in lowercase
    placeBetParams: {
      eventType: "joker120", // JOKER120 - Note : In saffron its is "joker120" in lowercase
      marketOddName: "joker120", // JOKER120 - Note : In saffron its is "joker120" in lowercase
      betEventName: "joker120", // JOKER120 - Note : In saffron its is "joker120" in lowercase
      betMarketType: "joker120", // JOKER120 - Note : In saffron its is "joker120" in lowercase
    },
    modalTitle: "Teenpatti Joker 20-20 Result",
...
export default PlacebetTeenPattijoker1;
