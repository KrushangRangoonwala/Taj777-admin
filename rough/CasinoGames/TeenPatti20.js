...
const TeenPatti20 = ({ onBetSelection, lastBetTime, exposureTrigger }) => {
  ...
  const renderExposure = (marketId) => {
    ...
    return (
      <span
        style={{ marginLeft: "5px", zIndex: 10, fontWeight: '100', color: exposure >= 0 ? "#39ff39" : "#f7505e" }}
      >
        {exposure}
      </span>
    );
  ...
  useEffect(() => {
    ...
    const joinRoom = () => {
      console.log("📤 Emitting Room: teen20");
      socket.emit("Room", "teen20");
    };

    socket.on("connect", () => {
      console.log("✅ Connected to game socket (teen20):", socket.id);
      joinRoom();
    });

    socket.on("reconnect", (attempt) => {
      console.log(
        `🔄 Reconnected to game socket (teen20) after ${attempt} attempts`
      );
      joinRoom();
    });
  ...
  const handleOddsClick = (teamName, odds, sid, isBack, hideOdds = false) => {
      ...
      <div className="casino-table teenpatti20b kk">
        {/* VIDEO SECTION */}
          <CasinoVideo
                  ...
                  videoSrc="https://casino.diamondcricketid.com/swiftdizire/?id=3030"
        ...
        <div className="casino-detail">
            ...
            <div className="teen20left">
              ...
              <div className="casino-bl-box">
                ...
                <div
                  ...
                  style={{
                    cursor: getOddsBySid(1)?.b1 ? "pointer" : "default",
                  }}
                >
                ...
                <div
                  ...
                  style={{
                    cursor: getOddsBySid(5)?.b1 ? "pointer" : "default",
                  }}
                >
                  <span className="casino-box-odd">
                    {getOddsBySid(5)?.b1 ? (
                ...
                <div
                  className={`back casino-bl-box-item ${getSuspendedClass(
                    getOddsBySid(11)?.gstatus
                  )}`}
                  onClick={() =>
                    getOddsBySid(11)?.b1 &&
                    handleOddsClick("Total A", getOddsBySid(11)?.b1, 11, true)
                  }
                  style={{
                    cursor: getOddsBySid(11)?.b1 ? "pointer" : "default",
                  }}
                >
                  <span className="casino-box-odd">
                    {getOddsBySid(11)?.b1 ? (
                      getOddsBySid(11)?.b1 || "0"
                    ) : (
                      <i className="fas fa-lock"></i>
                    )}
                  </span>
                ...
                <div
                  ...
                  onClick={() =>
                    getOddsBySid(3)?.b1 &&
                    handleOddsClick("Pair Plus A", getOddsBySid(3)?.b1, 3, true)
                  }
                  style={{
                    cursor: getOddsBySid(3)?.b1 ? "pointer" : "default",
                  }}
                >
                  <span className="casino-box-odd">
                    {getOddsBySid(3)?.b1 ? (
              ...
              {/* Suit Groups A */}
              <div className="casino-rb-box-container">
                {/* Black A */}
                <div className="casino-rb-box blackcontainer">
                  <div
                    className={`casino-rb-box-player blackbox back ${getSuspendedClass(
                      getOddsBySid(7)?.gstatus
                    )}`}
                    onClick={() =>
                      getOddsBySid(7)?.b1 &&
                      handleOddsClick("Black A", getOddsBySid(7)?.b1, 7, true)
                    }
                    style={{
                      cursor: getOddsBySid(7)?.b1 ? "pointer" : "default",
                    }}
                  >
                    <div className="text-right">
                      <img
                        src="https://wver.sprintstaticdata.com/v190/static/front/img/cards/spade.png"
                        alt="spade"
                      />
                      <img
                        src="https://wver.sprintstaticdata.com/v190/static/front/img/cards/club.png"
                        alt="club"
                      />
                    </div>
                    <div className="text-right">
                ...
                <div className="casino-rb-box redcontainer">
                  <div
                    className={`casino-rb-box-player redbox back ${getSuspendedClass(
                      getOddsBySid(8)?.gstatus
                    )}`}
                    onClick={() =>
                      getOddsBySid(8)?.b1 &&
                      handleOddsClick("Red A", getOddsBySid(8)?.b1, 8, true)
                    }
                    style={{
                      cursor: getOddsBySid(8)?.b1 ? "pointer" : "default",
                    }}
                  >
                    <div>
                      <img
                        src="https://wver.sprintstaticdata.com/v190/static/front/img/cards/heart.png"
                        alt="heart"
                      />
                      <img
                        src="https://wver.sprintstaticdata.com/v190/static/front/img/cards/diamond.png"
            ...
            <div className="teen20right">
              ...
              <div className="casino-bl-box">
                ...
                <div
                  ...
                  style={{
                    cursor: getOddsBySid(2)?.b1 ? "pointer" : "default",
                  }}
                >
                  <span className="casino-box-odd">
                    {getOddsBySid(2)?.b1 ? (
                ...
                <div
                  ...
                  style={{
                    cursor: getOddsBySid(6)?.b1 ? "pointer" : "default",
                  }}
                >
                  <span className="casino-box-odd">
                    {getOddsBySid(6)?.b1 ? (
                ...
                <div
                  className={`back casino-bl-box-item ${getSuspendedClass(
                    getOddsBySid(12)?.gstatus
                  )}`}
                  onClick={() =>
                    getOddsBySid(12)?.b1 &&
                    handleOddsClick("Total B", getOddsBySid(12)?.b1, 12, true)
                  }
                  style={{
                    cursor: getOddsBySid(12)?.b1 ? "pointer" : "default",
                  }}
                >
                  <span className="casino-box-odd">
                    {getOddsBySid(12)?.b1 ? (
                      getOddsBySid(12)?.b1 || "0"
                    ) : (
                      <i className="fas fa-lock"></i>
                    )}
                  </span>
                ...
                <div
                  ...
                  onClick={() =>
                    getOddsBySid(4)?.b1 &&
                    handleOddsClick("Pair Plus B", getOddsBySid(4)?.b1, 4, true)
                  }
                  style={{
                    cursor: getOddsBySid(4)?.b1 ? "pointer" : "default",
                  }}
                >
                  <span className="casino-box-odd">
                    {getOddsBySid(4)?.b1 ? (
              ...
              <div className="casino-rb-box-container">
                ...
                <div className="casino-rb-box blackcontainer">
                  <div
                    className={`casino-rb-box-player blackbox back ${getSuspendedClass(
                      getOddsBySid(9)?.gstatus
                    )}`}
                    onClick={() =>
                      getOddsBySid(9)?.b1 &&
                      handleOddsClick("Black B", getOddsBySid(9)?.b1, 9, true)
                    }
                    style={{
                      cursor: getOddsBySid(9)?.b1 ? "pointer" : "default",
                    }}
                  >
                    <div>
                      <img
                ...
                <div className="casino-rb-box redcontainer">
                  <div
                    className={`casino-rb-box-player redbox back ${getSuspendedClass(
                      getOddsBySid(10)?.gstatus
                    )}`}
                    onClick={() =>
                      getOddsBySid(10)?.b1 &&
                      handleOddsClick("Red B", getOddsBySid(10)?.b1, 10, true)
                    }
                    style={{
                      cursor: getOddsBySid(10)?.b1 ? "pointer" : "default",
                    }}
                  >
                    <div>
                      <img
          ...
          <div className="teen20casino-container d-none-big">
            ...
            <div className="casino-bl-box">
              ...
              <div
                ...
                style={{ cursor: getOddsBySid(1)?.b1 ? "pointer" : "default" }}
              >
                <span className="casino-box-odd">
                  {getOddsBySid(1)?.b1 ? getOddsBySid(1)?.b1 : <i className="fas fa-lock"></i>}
                </span>
                {renderExposure(1)}
              </div>
              ...
              <div
                ...
                style={{ cursor: getOddsBySid(2)?.b1 ? "pointer" : "default" }}
              >
                <span className="casino-box-odd">
                  {getOddsBySid(2)?.b1 ? getOddsBySid(2)?.b1 : <i className="fas fa-lock"></i>}
                </span>
                {renderExposure(2)}
              </div>
            </div>
            ...
            <div className="casino-bl-box">
              ...
              <div
                className={`back casino-bl-box-item ${getSuspendedClass(getOddsBySid(5)?.gstatus)}`}
                onClick={() =>
                  getOddsBySid(5)?.b1 &&
                  handleOddsClick("3 Baccarat A", getOddsBySid(5)?.b1, 5, true)
                }
                style={{ cursor: getOddsBySid(5)?.b1 ? "pointer" : "default" }}
              >
                <span className="casino-box-odd">
                  {getOddsBySid(5)?.b1 ? getOddsBySid(5)?.b1 : <i className="fas fa-lock"></i>}
                </span>
                {renderExposure(5)}
              </div>

              <div
                className={`back casino-bl-box-item ${getSuspendedClass(getOddsBySid(6)?.gstatus)}`}
                onClick={() =>
                  getOddsBySid(6)?.b1 &&
                  handleOddsClick("3 Baccarat B", getOddsBySid(6)?.b1, 6, true)
                }
                style={{ cursor: getOddsBySid(6)?.b1 ? "pointer" : "default" }}
              >
                <span className="casino-box-odd">
                  {getOddsBySid(6)?.b1 ? getOddsBySid(6)?.b1 : <i className="fas fa-lock"></i>}
                </span>
                {renderExposure(6)}
              </div>
            </div>
            ...
            <div className="casino-bl-box">
              ...
              <div
                className={`back casino-bl-box-item ${getSuspendedClass(getOddsBySid(11)?.gstatus)}`}
                onClick={() =>
                  getOddsBySid(11)?.b1 &&
                  handleOddsClick("Total A", getOddsBySid(11)?.b1, 11, true)
                }
                style={{ cursor: getOddsBySid(11)?.b1 ? "pointer" : "default" }}
              >
                <span className="casino-box-odd">
                  {getOddsBySid(11)?.b1 ? getOddsBySid(11)?.b1 : <i className="fas fa-lock"></i>}
                </span>
                {renderExposure(11)}
              </div>

              <div
                className={`back casino-bl-box-item ${getSuspendedClass(getOddsBySid(12)?.gstatus)}`}
                onClick={() =>
                  getOddsBySid(12)?.b1 &&
                  handleOddsClick("Total B", getOddsBySid(12)?.b1, 12, true)
                }
                style={{ cursor: getOddsBySid(12)?.b1 ? "pointer" : "default" }}
              >
                <span className="casino-box-odd">
                  {getOddsBySid(12)?.b1 ? getOddsBySid(12)?.b1 : <i className="fas fa-lock"></i>}
                </span>
                {renderExposure(12)}
              </div>
            </div>
            ...
            <div className="casino-bl-box">
              ...
              <div
                className={`back casino-bl-box-item ${getSuspendedClass(getOddsBySid(3)?.gstatus)}`}
                onClick={() =>
                  getOddsBySid(3)?.b1 &&
                  handleOddsClick("Pair Plus A", getOddsBySid(3)?.b1, 3, true, true)
                }
                style={{ cursor: getOddsBySid(3)?.b1 ? "pointer" : "default" }}
              >
                <span className="casino-box-odd">
                  {getOddsBySid(3)?.b1 ? 'A' : <i className="fas fa-lock"></i>}
                </span>
                {renderExposure(3)}
              </div>

              <div
                className={`back casino-bl-box-item ${getSuspendedClass(getOddsBySid(4)?.gstatus)}`}
                onClick={() =>
                  getOddsBySid(4)?.b1 &&
                  handleOddsClick("Pair Plus B", getOddsBySid(4)?.b1, 4, true, true)
                }
                style={{ cursor: getOddsBySid(4)?.b1 ? "pointer" : "default" }}
              >
                <span className="casino-box-odd">
                  {getOddsBySid(4)?.b1 ? 'B' : <i className="fas fa-lock"></i>}
                </span>
                {renderExposure(4)}
              </div>
            </div>
            ...
            <div className="casino-bl-box">
              ...
              <div
                className={`back casino-bl-box-item ${getSuspendedClass(getOddsBySid(7)?.gstatus)}`}
                onClick={() =>
                  getOddsBySid(7)?.b1 &&
                  handleOddsClick("Black A", getOddsBySid(7)?.b1, 7, true)
                }
                style={{ cursor: getOddsBySid(7)?.b1 ? "pointer" : "default" }}
              >
                <span className="casino-box-odd">
                  {getOddsBySid(7)?.b1 ? getOddsBySid(7)?.b1 : <i className="fas fa-lock"></i>}
                </span>
                {renderExposure(7)}
              </div>

              <div
                className={`back casino-bl-box-item ${getSuspendedClass(getOddsBySid(9)?.gstatus)}`}
                onClick={() =>
                  getOddsBySid(9)?.b1 &&
                  handleOddsClick("Black B", getOddsBySid(9)?.b1, 9, true)
                }
                style={{ cursor: getOddsBySid(9)?.b1 ? "pointer" : "default" }}
              >
                <span className="casino-box-odd">
                  {getOddsBySid(9)?.b1 ? getOddsBySid(9)?.b1 : <i className="fas fa-lock"></i>}
                </span>
                {renderExposure(9)}
              </div>
            </div>
            ...
            <div className="casino-bl-box">
              ...
              <div
                className={`back casino-bl-box-item ${getSuspendedClass(getOddsBySid(8)?.gstatus)}`}
                onClick={() =>
                  getOddsBySid(8)?.b1 &&
                  handleOddsClick("Red A", getOddsBySid(8)?.b1, 8, true)
                }
                style={{ cursor: getOddsBySid(8)?.b1 ? "pointer" : "default" }}
              >
                <span className="casino-box-odd">
                  {getOddsBySid(8)?.b1 ? getOddsBySid(8)?.b1 : <i className="fas fa-lock"></i>}
                </span>
                {renderExposure(8)}
              </div>

              <div
                className={`back casino-bl-box-item ${getSuspendedClass(getOddsBySid(10)?.gstatus)}`}
                onClick={() =>
                  getOddsBySid(10)?.b1 &&
                  handleOddsClick("Red B", getOddsBySid(10)?.b1, 10, true)
                }
                style={{ cursor: getOddsBySid(10)?.b1 ? "pointer" : "default" }}
              >
                <span className="casino-box-odd">
                  {getOddsBySid(10)?.b1 ? getOddsBySid(10)?.b1 : <i className="fas fa-lock"></i>}
                </span>
                {renderExposure(10)}
              </div>
            </div>
          ...
          {/* <div className="casino-video-last-results">
            <span className="resulta">A</span>
            <span className="resulta">A</span>
            <span className="resultb">B</span>
            <span className="resulta">A</span>
            <span className="resulta">A</span>
            <span className="resultb">B</span>
            <span className="resultb">B</span>
            ...
            <a
              href="/report/casinoresult/teen20c"
