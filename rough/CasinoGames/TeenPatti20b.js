...
const TeenPatti20b = ({ onBetSelection, lastBetTime, exposureTrigger }) => {
  ...
  useEffect(() => {
    ...
    const joinRoom = () => {
      console.log("📤 Emitting Room: teen20b");
      socket.emit("Room", "teen20b");
    };

    socket.on("connect", () => {
      console.log("✅ Connected to game socket (teen20b):", socket.id);
      joinRoom();
    });

    socket.on("reconnect", (attempt) => {
      console.log(
        `🔄 Reconnected to game socket (teen20b) after ${attempt} attempts`
      );
      joinRoom();
    });
    ...
    <>
      <div className="casino-table teenpatti20b kk">
        ...
        <CasinoVideo
          ...
          videoSrc="/mediaplayer/teen20b/95bba40e-0623-4fe3-a007-0b71f467e211"
        ...
        <div className="casino-detail">
          ...
          <div className="teen20casino-container d-none-big">
            ...
            <div className="casino-bl-box">
              ...
              >
                <span className="casino-box-odd">
                  {getOddsBySid(1)?.b1 ? getOddsBySid(1)?.b1 : <i className="fas fa-lock" />}
                </span>
                {renderExposure(1)}
              </div>
              ...
              >
                <span className="casino-box-odd">
                  {getOddsBySid(2)?.b1 ? getOddsBySid(2)?.b1 : <i className="fas fa-lock" />}
                </span>
                {renderExposure(2)}
              </div>
            </div>
            ...
            <div className="casino-bl-box">
              ...
              >
                <span className="casino-box-odd">
                  {getOddsBySid(5)?.b1 ? getOddsBySid(5)?.b1 : <i className="fas fa-lock" />}
                </span>
                {renderExposure(5)}
              </div>
              ...
              >
                <span className="casino-box-odd">
                  {getOddsBySid(6)?.b1 ? getOddsBySid(6)?.b1 : <i className="fas fa-lock" />}
                </span>
                {renderExposure(6)}
              </div>
            </div>
            ...
            <div className="casino-bl-box">
              ...
              >
                <span className="casino-box-odd">
                  {getOddsBySid(11)?.b1 ? getOddsBySid(11)?.b1 : <i className="fas fa-lock" />}
                </span>
                {renderExposure(11)}
              </div>
              ...
              >
                <span className="casino-box-odd">
                  {getOddsBySid(12)?.b1 ? getOddsBySid(12)?.b1 : <i className="fas fa-lock" />}
                </span>
                {renderExposure(12)}
              </div>
            </div>
            ...
            <div className="casino-bl-box">
              ...
              >
                <span className="casino-box-odd">
                  {getOddsBySid(3)?.b1 ? 'A' : <i className="fas fa-lock" />}
                </span>
                {renderExposure(3)}
              </div>
              ...
              >
                <span className="casino-box-odd">
                  {getOddsBySid(4)?.b1 ? 'B' : <i className="fas fa-lock" />}
                </span>
                {renderExposure(4)}
              </div>
            </div>
            ...
            <div className="casino-bl-box">
              <div className="casino-bl-box-item casino-odds-name casino-nation-name">
                <div>
                  <img src="https://wver.sprintstaticdata.com/v194/static/front/img/cards/spade.png" alt="spade" />
                  <img src="https://wver.sprintstaticdata.com/v194/static/front/img/cards/club.png" alt="club" />
                </div>
              </div>
              ...
              >
                <span className="casino-box-odd">
                  {getOddsBySid(7)?.b1 ? getOddsBySid(7)?.b1 : <i className="fas fa-lock" />}
                </span>
                {renderExposure(7)}
              </div>
              ...
              >
                <span className="casino-box-odd">
                  {getOddsBySid(9)?.b1 ? getOddsBySid(9)?.b1 : <i className="fas fa-lock" />}
                </span>
                {renderExposure(9)}
              </div>
            </div>
            ...
            <div className="casino-bl-box">
              <div className="casino-bl-box-item casino-odds-name casino-nation-name">
                <div>
                  <img src="https://wver.sprintstaticdata.com/v194/static/front/img/cards/heart.png" alt="heart" />
                  <img src="https://wver.sprintstaticdata.com/v194/static/front/img/cards/diamond.png" alt="diamond" />
                </div>
              </div>
              ...
              >
                <span className="casino-box-odd">
                  {getOddsBySid(8)?.b1 ? getOddsBySid(8)?.b1 : <i className="fas fa-lock" />}
                </span>
                {renderExposure(8)}
              </div>
              ...
              >
                <span className="casino-box-odd">
                  {getOddsBySid(10)?.b1 ? getOddsBySid(10)?.b1 : <i className="fas fa-lock" />}
                </span>
                {renderExposure(10)}
              </div>
            </div>
