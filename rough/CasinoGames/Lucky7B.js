...
const Lucky7B = ({ onBetSelection, lastBetTime, exposureTrigger }) => {
        ...
        `}
            ...
            <div className="betting-layout">
                ...
                <div className="row-side-bets">
                    <BettingBox sid={3} teamName="Even" label="EVEN" extraStyle={{ backgroundColor: "#2580f48a" }} textColor="#FFF" />
                    <BettingBox sid={4} teamName="Odd" label="ODD" extraStyle={{ backgroundColor: "#2580f48a" }} textColor="#FFF" />
                    <BettingBox sid={5} teamName="Black" extraStyle={{ backgroundColor: "#2580f48a" }} textColor="#FFF">
                    ...
                    <BettingBox sid={6} teamName="Red" extraStyle={{ backgroundColor: "#2580f48a" }} textColor="#FFF">
                        <div style={{ display: "flex", marginTop: "2px" }}>
