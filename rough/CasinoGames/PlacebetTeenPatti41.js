...
const TeenPatti41ResultModalContent = ({ modalContent, onClose }) => {
  ...
  return (
    <>
      ...
      >
        ...
        >
          Queen Top Open Teenpatti Result
        </span>
        <span
          onClick={onClose}
          style={{
...
const PlacebetTeenPatti41 = ({
  ...
  const config = {
    marketType: "teen41",
    curPageName: "live_teen41.php",
    socketRoom: "teen41",
    resultApiType: "teen41",
    placeBetUrl: "bet_place_teen41.php",
    gtype: "teen41",
    placeBetParams: {
      eventType: "teen41",
      marketOddName: "teen41",
      betEventName: "teen41",
      betMarketType: "teen41",
    },
    modalTitle: "Queen Top Open Teenpatti Result",
  ...
  return (
    <PlaceBet_KK
      ...
      ResultModal={TeenPatti41ResultModalContent}
...
export default PlacebetTeenPatti41;
