...
const AndarBahar150 = ({ onBetSelection, lastBetTime }) => {
    ...
    const iframeUrl = iframe_url || "https://casino.diamondcricketid.com/swiftdizire/?id=3084";
    const resultImage = result_image || "/cards_new/";
    ...
    useEffect(() => {
        ...
        const handleData = (data) => {
            try {
                ...
                console.error("Error processing AndarBahar150 data:", error);
            }
        };
        ...
        const handleGameResult = (data) => {
            try {
                ...
                console.error("Error processing AndarBahar150 gameResult:", error);
            }
        };

        const handleConnect = () => {
            console.log(`✅ ${game_type} Connected:`, socket.id);
            socket.emit("Room", "ab4"); // Using ab4 for Andar Bahar 150 Cards
        };
            ...
            <div className="center-main-container">
                <div className="center-content">
                    <div className="casino-container">
                        <div className="casino-table andar-bahar2 ab4">
                            <CasinoVideo
                                gameName={gameName}
