    ...
    useEffect(() => {
        ...
        const handleData = (data) => {
            try {
                ...
                console.error("Error processing JackTopOpenTeenPatti data:", error);
            }
        };
                                                ...
                                                <div className="casino-nation-name">
                                                    ...
                                                    <div className="float-right">
                                                        ...
                                                        <BetLimitInfo 
                                                            ...
                                                            openRanges={openRanges} 
                                                            toggleRange={toggleRange} 
                                                            min={getMarketByName("Player B Under 21")?.min} 
                                                            max={getMarketByName("Player B Under 21")?.max} 
                                                            fallbackMax={50000}
                                                        />
                                                    </div>
                                                </div>
                                                ...
                                                <div className="casino-nation-name">
                                                    ...
                                                    <div className="float-right">
                                                        ...
                                                        <BetLimitInfo 
                                                            ...
                                                            openRanges={openRanges} 
                                                            toggleRange={toggleRange} 
                                                            min={getMarketByName("Player B Over 21")?.min} 
                                                            max={getMarketByName("Player B Over 21")?.max} 
                                                            fallbackMax={50000}
                                                        />
                                                    </div>
                                                </div>
...
export default JackTopOpenTeenPatti;
