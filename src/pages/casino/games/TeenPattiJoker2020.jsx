...
const TeenPattiJoker2020 = ({ onBetSelection, exposureData, lastResults: propsLastResults }) => {
                                                        ...
                                                        <BetBox marketName="Joker Even" className="back casino-bl-box-item" type="back">
                                                            {(odds) => (
                                                                <>
                                                                    ...
                                                                    <Exposure className="book-black" data={exposureData} id={getMarketByName("Joker Even")?.sid} />
                                                                </>
                                                            )}
                                                        </BetBox>
                                                        ...
                                                        <BetBox marketName="Joker Odd" className="back casino-bl-box-item" type="back">
                                                            {(odds) => (
                                                                <>
                                                                    ...
                                                                    <Exposure className="book-black" data={exposureData} id={getMarketByName("Joker Odd")?.sid} />
                                                                </>
                                                            )}
                                                        </BetBox>
                                                        <div className="text-right casino-rb-box-player-range w-100 mt-1">
                                                        ...
                                                        <BetBox marketName="Joker Red" className="back casino-bl-box-item casino-card-img" type="back">
                                                            {(odds) => (
                                                                <>
                                                                    ...
                                                                    <Exposure className="book-black" data={exposureData} id={getMarketByName("Joker Red")?.sid} />
                                                                </>
                                                            )}
                                                        </BetBox>
                                                        <div className="text-right casino-rb-box-player-range w-100 mt-1">
                                                        ...
                                                        <BetBox marketName="Joker Black" className="back casino-bl-box-item casino-card-img" type="back">
                                                            {(odds) => (
                                                                <>
                                                                    ...
                                                                    <Exposure className="book-black" data={exposureData} id={getMarketByName("Joker Black")?.sid} />
                                                                </>
                                                            )}
                                                        </BetBox>
                                                        <div className="text-right casino-rb-box-player-range w-100 mt-1">
