...
const TeenPattiPoison2020 = ({ onBetSelection, exposureData, lastResults: propsLastResults }) => {
    ...
    useEffect(() => {
        ...
        const handleData = (data) => {
            try {
                ...
                console.error("Error processing TeenPattiPoison2020 data:", error);
            }
        };
    ...
    const Cards = () => (
        <div className="casino-video-cards-container">
            <div className="poison-card joker-card">
                ...
                <div className="center-main-container">
                    <div className="center-content">
                        <div className="casino-container">
                            <div className="casino-table teenpatti-poison teenpatti-joker">
                                <CasinoVideo
                                    gameName={game_name}
                                ...
                                <div className="casino-detail">
                                    <div className="teen1daycasino-container mt-2">
                                        ...
                                        <div className="teen1dayright poison-other joker-other">
                                            <div>
                                                <div className="casino-box-row casino-odds">
                                                    <div className="text-left w-100"><b className="text-playerb">Poison</b></div>
                                                </div>
                                                <div className="casino-box-row">
                                                ...
                                                <div className="casino-box-row">
                                                    <div className="casino-bl-box">
                                                        <BetBox marketName="Poison Even" className="back casino-bl-box-item" type="back">
                                                            {(odds) => (
                                                                <>
                                                        ...
                                                        <div className="text-right casino-rb-box-player-range w-100 mt-1">
                                                            <BetLimitInfo
                                                                ...
                                                                openRanges={openRanges}
                                                                toggleRange={toggleRange}
                                                                min={getMarketByName("Poison Even")?.min}
                                                                max={getMarketByName("Poison Even")?.max}
                                                    ...
                                                    <div className="casino-bl-box">
                                                        <BetBox marketName="Poison Odd" className="back casino-bl-box-item" type="back">
                                                            {(odds) => (
                                                                <>
                                                        ...
                                                        <div className="text-right casino-rb-box-player-range w-100 mt-1">
                                                            <BetLimitInfo
                                                                ...
                                                                openRanges={openRanges}
                                                                toggleRange={toggleRange}
                                                                min={getMarketByName("Poison Odd")?.min}
                                                                max={getMarketByName("Poison Odd")?.max}
                                                                iconClass="float-right"
                                                                fallbackMax={300000}
                                                            />
                                                        </div>
                                                    ...
                                                    <div className="casino-bl-box">
                                                        <BetBox marketName="Poison Red" className="back casino-bl-box-item casino-card-img" type="back">
                                                            {(odds) => (
                                                                <>
                                                                    <span>
                                                        ...
                                                        <div className="text-right casino-rb-box-player-range w-100 mt-1">
                                                            <BetLimitInfo
                                                                ...
                                                                openRanges={openRanges}
                                                                toggleRange={toggleRange}
                                                                min={getMarketByName("Poison Red")?.min}
                                                                max={getMarketByName("Poison Red")?.max}
                                                                iconClass="float-right"
                                                                fallbackMax={300000}
                                                            />
                                                        </div>
                                                    ...
                                                    <div className="casino-bl-box">
                                                        <BetBox marketName="Poison Black" className="back casino-bl-box-item casino-card-img" type="back">
                                                            {(odds) => (
                                                                <>
                                                                    <span>
                                                        ...
                                                        <div className="text-right casino-rb-box-player-range w-100 mt-1">
                                                            <BetLimitInfo
                                                                ...
                                                                openRanges={openRanges}
                                                                toggleRange={toggleRange}
                                                                min={getMarketByName("Poison Black")?.min}
                                                                max={getMarketByName("Poison Black")?.max}
                                                                iconClass="float-right"
                                                                fallbackMax={300000}
                                                            />
                                                        </div>
                                            ...
                                            <div className="mt-1">
                                                ...
                                                <div className="casino-box-row">
                                                    {[
                                                        { name: "Poison Spade", range: "range7" },
                                                        { name: "Poison Heart", range: "range8" },
                                                        { name: "Poison Diamond", range: "range9" },
                                                        { name: "Poison Club", range: "range10" }
                                                    ].map((suit, i) => (
...
export default TeenPattiPoison2020;
