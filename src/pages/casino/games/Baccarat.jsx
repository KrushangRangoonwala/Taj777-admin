...
const Baccarat = ({ onBetSelection, lastBetTime }) => {
                            ...
                            <div className="casino-detail">
                                <div className="baccarat-bets-odds pt-3">
                                    <div className="baccarat-odds">
                                        <OddBlock sid={6} label="Perfect Pair" oddsText={getMarketOdds(6) || "25:1"} rangeId="1" />
                                        <OddBlock sid={7} label="Big" oddsText={getMarketOdds(7) || "0.54:1"} rangeId="2" />
                                        <OddBlock sid={8} label="Small" oddsText={getMarketOdds(8) || "1.5:1"} rangeId="3" />
                                        <OddBlock sid={9} label="Either Pair" oddsText={getMarketOdds(9) || "5:1"} rangeId="4" />
                                    </div>
                                ...
                                <LastResult results={lastResults} resultPath="baccarat" />
                            </div>
                        </div>
                    </div>
                </div>
