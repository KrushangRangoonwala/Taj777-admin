...
const VideoRules = ({ onClose, gameName }) => {
    return (
        <div
        ...
        >
            <div className="rules-header">
                <div>Rules</div> <i className="fas fa-times" onClick={onClose}></i>
            </div>
...
export function GameRules({ gameName }) {
    const [activeTabLottery, setActiveTabLottery] = useState("rules");

    if (gameName === "Teenpatti Test") {
        return (
            <>
                <div>
    ...
    if (gameName === "Unlimited Joker 20-20") {
        return (
            <div>
                <div className="rules-section">
                    <p>
    ...
    if (gameName === "Cricket Match 20-20") {
        return (
            <div>
                <div className="rules-section">
    ...
    if (gameName === "Poker 6 Players" || gameName === "Poker 1-Day" || gameName === "20-20 Poker") {
        return (
            <div>
                <div className="rules-section">
                    <div>
    ...
    if (gameName === "Sic Bo" || gameName === "Sic Bo 2") {
        return (
            <>
                <div>
                    <div className="rules-section">
    ...
    if (gameName === "1 Day Dragon Tiger" || gameName == "20-20 Dragon Tiger 2" || gameName === "20-20 Dragon Tiger") {
        return (
            <div>
                <div className="rules-section">
                    <div>
                        ...
                        {(gameName === "20-20 Dragon Tiger 2" || gameName === "20-20 Dragon Tiger") && (
                            <img
    ...
    if (gameName === "Beach Roulette" || gameName == "Roulette" || gameName == "Golden Roulette") {
        return (
            <>
                <div>
                    <div className="rules-section">
                ...
                {gameName === "Beach Roulette" || gameName == "Golden Roulette" && (
                    <div className="rules-section">
    ...
    if (gameName === "V Vip Teenpatti 1-Day" || gameName === "Teenpatti 1-day") {
        return (
            <>
                <div>
                    <div className="rules-section">
    ...
    if (gameName === "Teenpatti Joker 20-20" || gameName === "Unlimited Joker 20-20" || gameName === "Unlimited Joker Oneday") {
        return (
            <div>
                <div className="rules-section">
    ...
    if (gameName === "20-20 Teenpatti C" || gameName === "20-20 Teenpatti B" || gameName === "20-20 Teenpatti") {
        return (
            <>
                <div>
                    <div className="rules-section">
    ...
    if (gameName === "Queen Top Open Teenpatti") {
        return (
            <>
                <div>
                    <div className="rules-section">
    ...
    if (gameName === "Jack Top Open Teenpatti") {
        return (
            <>
                <div>
                    <div className="rules-section">
    ...
    if (gameName === "Instant Teenpatti 3.0") {
        return (
            <>
                <div>
                    <div className="rules-section">
    ...
    if (gameName === "Instant Teenpatti 2.0") {
        return (
            <>
                <div>
                    <div className="rules-section">
    ...
    if (gameName === "Baccarat" || gameName === "Baccarat 2") {
        return (
            <>
                <div>
                    <div className="rules-section">
    ...
    if (gameName === "32 CARDS A" || gameName === "32 Cards B") {
        return (
            <div>
                <div className="rules-section">
                    <div className="table-responsive">
    ...
    if (gameName === "ANDAR BAHAR 150 CARDS") {
        return (
            <div>
                <div className="rules-section">
                    <ul className="pl-4 pr-4 list-style">
    ...
    if (gameName === "ANDAR BAHAR 50 CARDS") {
        return (
            <div>
                <div className="rules-section">
                    <ul className="pl-4 pr-4 list-style">
    ...
    if (gameName === "Lucky 7 - A" || gameName === "Lucky 7 - B" || gameName === "Lucky 7 - C") {
        return (
            <div>
                <div className="rules-section">
                    <ul className="pl-4 pr-4 list-style">
    ...
    if (gameName === "Bollywood Casino 2" || gameName === "Bollywood Casino") {
        return (
            <div>
                <div className="rules-section">
                    <ul className="pl-4 pr-4 list-style">
    ...
    if (gameName === "Amar Akbar Anthony 2" || gameName === "Amar Akbar Anthony") {
        return (
            <>
                <div>
                    <div className="rules-section">
    ...
    if (gameName === "Teenpatti Poison One Day" || gameName === "Teenpatti Poison 20-20") {
        return (
            <div>
                <div className="rules-section">
                    <p style={{ display: "block" }}>
                        Welcome to <b>{gameName}</b>, a new variation of
                        Teenpatti.
                    </p>
                    <p style={{ display: "block" }}>
                        As Teenpatti games are becoming more and more famous and popular on
                        our platforms, we are excited to introduce you to{" "}
                        <b>{gameName}</b>. The game follows the same standard
